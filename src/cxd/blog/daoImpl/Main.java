...
public class Main {
	public static void main(String[] args) {
		CommentDao adi = CommentDaoImpl.getInstance();
		...
		String coo = "tteeetest";
		
		Comment comment = new Comment(6, "shiyishi", "47074", coo, 15, "3412423", "1970-01-01 00:00:01");
		
		adi.addComment(comment);
